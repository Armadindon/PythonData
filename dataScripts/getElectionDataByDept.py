...
if __name__ == "__main__":
    fileDept = open("data/departements.csv")
    ...
    "https://www.interieur.gouv.fr/Elections/Les-resultats/Presidentielles/elecresult__presidentielle-2017/(path)/presidentielle-2017/{codeRegion}/{codeDept}/index.html"
    for commune in deptReader:
        ...
        deptDataRequest = requests.get("https://www.interieur.gouv.fr/Elections/Les-resultats/Presidentielles/elecresult__presidentielle-2017/(path)/presidentielle-2017/"+ formatNumberOfChar(commune["code_region"],3) +"/"+ formatNumberOfChar(commune["code_departement"],3) +"/index.html")
    ...
    with open("data/votes_departements.csv","w+",newline="") as csvData:
